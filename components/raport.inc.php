    <section class="gallery">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10">
                    <H1>Raporty leków</h1>
                    <a href='raport.php?utylizacja'><button type='button'
                            class='btn btn-outline-secondary btn-lg m-3 ml-5'>
                            Utylizacji
                        </button></a>
    ...
    <table class="table table-hover ">
        <thead>
            <tr>
                <th scope="col">L.p.</th>
                <th scope="col">Id Leku</th>
                <th scope="col">Data utylizacji</th>
                <!-- <th scope="col"></th> -->
                <!-- <th scope="col">Zutylizowana ilość</th> -->
            </tr>
        </thead>
